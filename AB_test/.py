...
# Shapiro methodu = dağılımın normal olup olmadığını kontrol eder.
...
# p-value < alpha, ise 0.05 'ten HO RED.
# p-value < alpha, değilse 0.05 H0 REDDEDILEMEZ.
...
"""
*Normallik varsayımı sağlanıyorsa, **ttest kullanılabilir*** 

*Normallik varsayımı sağlanıyor ve varyans homojenliği **ttest kullanılabilir*** 

*Normallik varsayımı sağlanıyor ve varyans homojenliği sağlanmıyorsa, 
    **ttest kullanılabilir → bu durumda equal_var = False**  olarak girilir.*
